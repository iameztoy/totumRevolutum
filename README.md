...
- `GEE/LanSenView.js` – POI imagery explorer combining Sentinel-2, Landsat, and Sentinel-1 visualizations, including improved Landsat cross-mission composite handling and more stable date grouping to avoid missing tiles.
...
- work with more consistent Landsat composites across missions and improved grouped-date behavior.
...
- Add a compact changelog section maintained per release/update.
